...
| E7 | **Release engineering — first real run** | workflow written | Nothing pushed yet: push branch, let `wallet-release.yml` run, verify Win/Linux packages (only macOS built locally), run the portable BYO-Java zip on a clean Java-25 machine. |
